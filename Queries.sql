...
CREATE TABLE
    ...
    -- CREATE_LOAD_CONTACTS:
CREATE TABLE
    IF NOT EXISTS load_contacts (
...
CREATE TABLE
    ...
    -- CREATE_DRIVER_INTEREST:    
CREATE TABLE
    IF NOT EXISTS driver_interest (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE
    ...
    -- CREATE_LOAD_CONFERENCE:    
CREATE TABLE
    IF NOT EXISTS load_conference (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        driver_user_id INTEGER NOT NULL,
        load_id TEXT NOT NULL,
        result TEXT,
